 ...
 * <p>Description: </p>
 *
 * <p>Copyright: Copyright (c) 2015 DigitalChina corporation</p>
 *
...
public class SercurityUtil {
	...
	public static final String Salt = "&^&Q*&W,";//盐值
	public static final String PASSWORD = "admin";//密钥
	...
	public static void main(String[] args) {
		...
		try {
//			byte[] salt = Integer.toString(i).getBytes();8e38aa7f1aafcc6f
			byte[] salt = SercurityUtil.getStaticSalt();
			System.out.println(new String(salt));
			String ciphertext = SercurityUtil.encrypt(str, password, salt);
			System.out.println(ciphertext);
			String plaintext = SercurityUtil.decrypt(ciphertext, password, salt);
