...
public interface Constants {
	 ...
	 * 非常遗憾的通知您,程序发生了异常
	 */
	static final String Exception_Head = "OH, We are very Sorry! SOME ERRORS OCCURED! AS FOLLOWS :";
	/** 缓存键值 */
	static final Map<Class<?>, String> cacheKeyMap = new HashMap<>();
	/** 操作名称 */
	...
	/** 缓存命名空间 */
	static final String CACHE_NAMESPACE = "IctFrame:";
	/** 缓存命名空间 */
	static final String SYSTEM_CACHE_NAMESPACE = "S:IctFrame:";
	/** 缓存命名空间 */
	static final String CACHE_NAMESPACE_LOCK = "L:IctFrame:";
	/** 上次请求地址 */
